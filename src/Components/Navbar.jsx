      ...
      <div className=" justify-center px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8 ">
        ...
        <div>
          ...
          className={`flex-1 justify-self-center pb-3 mt-8 md:block md:pb-0 md:mt-0 ${
            ...
            <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0 bg-white">
              <li className="text-gray-700 text-sm hover:text-gray-300 bg-white">
                <Link to="/">Home</Link>
              </li>
              <li
