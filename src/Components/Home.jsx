...
const Home = () => {
  return (
    <div className="md:container md:mx-auto">
      ...
      <div className="text-gray-600 body-font flex justify-center my-8">
        <div className="container px-5 -py-2 flex flex-col justify-center">
          ...
          />
            ...
            <div className="flex flex-col  sm:flex-row border rounded-xl px-8 bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] ">
              ...
              <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l flex flex-col justify-center border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                <p className="leading-relaxed text-lg mb-4">
                I'm Nandini, a web developer and software engineer 
                with a solid computer science background. Currently i am 
                committed to a year-long project but I'm available 
                for shorter consulting tasks. This involves potentially
                 aiding charities or mentoring aspiring engineers, 
                 something that brings me immense joy <br />
                </p>
